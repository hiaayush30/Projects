...
const Todo = ({todo}) => {
  ...
  return (
    <div className='flex justify-between gap-5 items-center mt-5 bg-zinc-900 px-3 py-3 rounded-lg'>
      <div className={`text-2xl ${todo.isCompleted ? 'line-through':''}`}>{todo.content}</div>
